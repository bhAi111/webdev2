...
include_once('migration/user-table.php');
include_once('migration/product-table.php');
include_once('migration/transaction-table.php');
include_once('migration/transaction-item-table.php');
